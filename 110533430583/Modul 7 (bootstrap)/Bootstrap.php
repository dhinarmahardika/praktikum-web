...
<head>
    ...
    <link href="bootstrap.css" rel="stylesheet" type="text/css" href="">
</head>
<body>
 <?php
      $conn=mysql_connect("localhost","root","root") or die ("Gagal Menyambung ke server");
      mysql_select_db("_testweb") or die ("Gagal membuka database");
    ?>
